...
//                   className="flex-1 px-4 py-3 rounded-full text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-white text-md md:text-base"
//                 />
...
//                 <p className="text-md md:text-base text-gray-400">Network Financial Services</p>
//               </div>
//               <p className="text-gray-300 mb-6 leading-relaxed text-md md:text-base">
...
//                   <span className="text-md md:text-base text-gray-300">123 Financial District, Lagos, Nigeria</span>
//                 </div>
//                 <div className="flex items-center space-x-3">
//                   <Phone className="h-4 w-4 md:h-5 md:w-5 text-blue-400 flex-shrink-0" />
//                   <span className="text-md md:text-base text-gray-300">+234 (0) 123 456 7890</span>
//                 </div>
//                 <div className="flex items-center space-x-3">
//                   <Mail className="h-4 w-4 md:h-5 md:w-5 text-blue-400 flex-shrink-0" />
//                   <span className="text-md md:text-base text-gray-300">info@smartkash.ng</span>
//                 </div>
//               </div>
//             </div>
...
//                           <Link
//                             href={link.href}
//                             className="text-gray-300 hover:text-white transition-colors duration-200 text-md md:text-base hover:underline"
//                           >
//                             {link.name}
//                           </Link>
//                         </li>
...
//             <div className="text-md md:text-md text-gray-400 text-center md:text-left">
//               © {currentYear} SmartKash Network Financial Services. All Rights Reserved.
//             </div>
//             <div className="flex flex-wrap justify-center md:justify-end items-center gap-2 md:gap-6 text-md md:text-md text-gray-400">
