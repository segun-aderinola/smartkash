          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-1">
              <div className="mb-6">
                ...
                <p className="text-sm text-gray-400">Network Financial Services</p>
              </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-sm text-gray-300">123 Financial District, Lagos, Nigeria</span>
                </div>
                <div className="flex items-center space-x-3">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-sm text-gray-300">info@smartkash.ng</span>
                </div>
              </div>
            </div>
