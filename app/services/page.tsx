  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8 scroll-animate opacity-0 translate-y-8 transition-all duration-700">
            {[
              ...
              <div key={index} className="text-center group">
                <div
                  className={`w-16 h-16 ${stat.color} rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300 shadow-lg`}
                >
      ...
      {/* <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 scroll-animate opacity-0 translate-y-8 transition-all duration-700">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">Simple steps to access our financial services</p>
          </div>
            ...
            {[
              {
                step: "01",
                title: "Apply Online",
                description: "Submit your application through our digital platform",
              ...
              },
              {
                step: "03",
                title: "Get Approved",
                description: "Receive approval notification and terms",
                icon: <CheckCircle className="h-6 w-6" />,
              },
              {
                step: "04",
                title: "Access Funds",
                description: "Funds are disbursed to your account quickly",
              ...
              >
                <div className="relative mb-6">
                  <div className="w-16 h-16 bg-blue-600 rounded-full flex items-center justify-center mx-auto text-white font-bold text-lg shadow-lg group-hover:scale-110 transition-transform duration-300">
                    {item.icon}
                  </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center scroll-animate opacity-0 translate-y-8 transition-all duration-700">
          <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-3xl p-12 shadow-xl">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Join thousands of satisfied customers who trust SmartKash with their financial needs.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                size="lg"
                className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-full text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
              >
                Get Started Today
                <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
