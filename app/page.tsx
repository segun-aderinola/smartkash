...
export default function HomePage() {
  ...
  const services = [
    ...
    },
    {
      ...
      description:
        "Comprehensive risk assessment and management solutions to protect and grow your wealth securely.",
    },
  ];
  ...
  const detailedServices = [
    ...
    },
    {
      ...
      description:
        "Mutual funds, stocks, bonds, real estate investments, and retirement accounts for wealth building.",
  ...
  const securityFeatures = [
    {
      ...
      description:
        "Multi-layered security protocols protecting your financial data and transactions.",
    },
    {
      icon: <Eye className="h-8 w-8 text-green-600" />,
      title: "Transparent Operations",
      description:
        "Clear, honest communication with full transparency in all our financial dealings.",
    },
    {
      icon: <CheckCircle className="h-8 w-8 text-red-600" />,
      title: "Regulatory Compliance",
      description:
        "Fully licensed and compliant with all financial regulations and industry standards.",
    },
    {
      icon: <Lock className="h-8 w-8 text-orange-600" />,
      title: "Data Protection",
      description:
        "End-to-end encryption and secure data handling to protect your personal information.",
    },
    {
      icon: <Bell className="h-8 w-8 text-teal-600" />,
      title: "Real-time Monitoring",
      description:
        "Continuous monitoring and instant alerts for all account activities and transactions.",
    },
    {
      icon: <Headphones className="h-8 w-8 text-purple-600" />,
      title: "24/7 Customer Support",
      description:
        "Round-the-clock dedicated support to assist with all your financial needs.",
    },
  ];
    ...
    <div className="bg-white">
      ...
      <section className="relative overflow-hidden">
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, rgb(0 10 54) 0%, rgb(225 197 255) 100%)",
          }}
        />
              ...
              <div className="relative hero-image-container h-48 xs:h-56 sm:h-64 md:h-80 lg:h-96 xl:h-screen flex items-end">
                ...
                <div className="absolute -top-2 sm:-top-4 -right-2 sm:-right-4 bg-white/20 backdrop-blur-sm rounded-xl sm:rounded-2xl p-3 sm:p-4 lg:p-5 animate-float z-10">
                  <div className="flex items-center space-x-2 sm:space-x-3 text-white">
                    ...
                    <div>
                      <div className="text-md sm:text-md lg:text-base font-semibold">
                        120K+
                      </div>
                      <div className="text-md sm:text-md opacity-80">
                        Clients Served
                      </div>
                    </div>
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-base sm:text-lg lg:text-xl text-gray-600 max-w-3xl mx-auto">
              Professional expertise across the broad spectrum of financial
              services
            </p>
          </div>
            ...
            <div className="space-y-4 sm:space-y-5 lg:space-y-6">
              ...
              <div className="space-y-3 sm:space-y-4 text-gray-600 leading-relaxed">
                <p className="text-md sm:text-base lg:text-lg">
                  SmartKash is your single resource for comprehensive and fully
                  integrated wealth management services. We help you maximize
                  your wealth base, fulfill your dreams and aspirations, and
                  secure a financial future for you and your loved ones.
                </p>
                <p className="text-md sm:text-base lg:text-lg">
                  We pride ourselves on our commitment to delivering
                  personalized service that focuses on the journey with you to
                  realize your dreams. Our objective advice spans the broad
                  spectrum of financial services with specialized expertise.
                </p>
                <p className="text-md sm:text-base lg:text-lg">
                  As your client, your best interests are always our first
                  priority. We strive to develop deep, meaningful relationships
          ...
          <div className="text-center mb-12 sm:mb-14 lg:mb-16 p-5">
            ...
            <div className="bg-gradient-to-br from-blue-600 to-purple-600 p-5 border-lg">
              ...
              <p className="text-base sm:text-lg lg:text-xl text-white max-w-3xl mx-auto">
                From personal finance to business growth, we provide
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-14 lg:mb-16">
            ...
            <p className="text-base sm:text-lg lg:text-xl text-gray-600 max-w-3xl mx-auto">
              Built on trust, integrity, and professional excellence with
      ...
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg sm:text-xl lg:text-2xl mb-6 sm:mb-7 lg:mb-8 opacity-90">
            Let's navigate the financial landscape together. With our expertise
            and your vision, the possibilities are endless.
          </p>
          <Link href="/services">
            <Button
              size="lg"
